...
fact{all r:Reader | host[loc[r]]=host[d[r]] }
fact{all w:Writer | host[loc[w]]=host[d[w]] }
...
fact { #MemoryLocation = 2 and #Thr = 2 and #Init = 2 and #Writer = 3 and #GetF = 1}
